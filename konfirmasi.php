        ...
        <div class="card">
            <div class="card-body">
                <center>
                    ...
                    <hr/>
                    <p>DANA A/N Adiba Shofwatun Naja 08813741157</p>
                    <a href="https://link.dana.id/minta/2u3nfv2qvv3" target="_blank" class="btn btn-primary">Atau Klik Disini</a>
                </center>
            </div>
        </div>
    </div>
    <div class="col-sm-8">
        <div class="card">
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=konfirmasi">
                    <table class="table">
                        ...
                        <tr>
                            <td>No Rekening</td>
                            <td>:</td>
                            <td><input type="text" name="no_rekening" required class="form-control" placeholder="Isikan Nomer Rekening Anda"></td>
                        </tr>
                        <tr>
                            <td>Atas Nama</td>
                            <td>:</td>
                            <td><input type="text" name="nama_rekening" required class="form-control" placeholder="Isikan Nama Anda"></td>
                        </tr>
                        <tr>
                            <td>Nominal</td>
                            <td>:</td>
                            <td><input type="text" name="nominal" required class="form-control" placeholder="Isikan Jumlah Pembayaran"></td>
                        </tr>
                        <tr>
               ...
               <br><br>
               <a href="https://wa.me/085647773475" class="btn btn-primary">Kirim Bukti Pembayaran Disini</a>
           </div>
        </div> 
    </div>
</div>
